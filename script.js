...
const subjects = {
    ...
    hindi: {
        name: "🇮🇳 Hindi (2nd Language)",
        examDate: "Friday, 11 July 2025",
        chapters: [
            "गद्य भाग -1 बात अठों की",
            "पूर्वाभ्यासी शब्द (एक से लेकर किनारा तक)",
            "विलोम शब्द (अधर्म से लेकर ऐश्वर्य तक)",
            "शब्द शुद्ध कीजिए",
            "पत्र लेखन (ौपचारिक)",
            "गद्य भाग 2 - काकी",
            "अनेक शब्द के लिए एक शब्द (1 से 39 तक)",
            "पत्र लेखन (ौपचारिक अनौपचारिक पत्र)",
            "एकाकी संपूर्ण - संस्कार और भावना",
            "मुहावरे (1 से लेकर 33 तक)",
            "अपठित गद्यांश",
            "भाववाचक (अतिथि से मूर्ख तक)",
            "विशेषण (धर्म से लेकर ईश्वर तक)",
            "काल, वचन, लिंग"
        ]
    },
    kannada: {
        name: "🇮🇳 Kannada (3rd Language)",
        examDate: "Saturday, 12 July 2025",
        chapters: [
            "ಸಾಹಿತ್ಯ ಸಂಗಮ - ಶಿವರತ್ನತ್ರಯ ಕಥೆ",
            "ಸಾಟಿಮೀಯೊದು - ಅಧ್ಯಾಯ 1",
            "ಪತ್ರವೆಂಬನೆ",
            "ಅಧರ ಗುಣದಾಸ",
            "ಪಾಕರಲಾಖ"
